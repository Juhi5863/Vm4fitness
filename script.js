...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function startAutoSlide() {
    autoSlideInterval = setInterval(showNextSlide, 4000); // Auto-slide every 4 seconds (slower)
  }
  ...
  const nextButton = document.querySelector(".profile-nextbtn");
  const prevButton = document.querySelector(".profile-prevbtn");
